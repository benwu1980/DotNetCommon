...
namespace DotNetCommon.Helper
{
    /// <summary>
    /// ini文件读写帮助类
    /// 注：如果读不出值,将ini文件编码由 utf-8 改为 unicode 后
    /// </summary>
    public class INIHelper
    {
        ...
        /// <summary>
        /// 路径,默认的为当前程序目下的,且文件名为Config.ini
        /// </summary>
        ...
        //读取Ini文件
        [DllImport("kernel32")]
        private static extern string GetPrivateProfileInt(string lpApplicationName, string lpKeyName, int nDefault, string lpFileName);
        ...
        /// <summary>
        /// 构造函数,默认defaultAppName 是  MyApp
        /// </summary>
        public INIHelper()
        {
            _defaultAppName = "MyApp";
        }
